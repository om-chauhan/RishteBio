...
const TEMPLATES: TemplateConfig[] = [
  ...
  { id: TemplateType.ELEGANT, name: 'Elegant', thumbnail: 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80&w=400', description: 'Sophisticated gold-accented luxury design.' },
  { id: TemplateType.ROYAL, name: 'Royal', thumbnail: 'https://images.unsplash.com/photo-1518998053901-5348d3961a04?auto=format&fit=crop&q=80&w=400', description: 'Premium purple & gold royal theme.' },
  { id: TemplateType.FLORAL, name: 'Floral', thumbnail: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&q=80&w=400', description: 'Delicate pink botanical-inspired design.' },
  { id: TemplateType.CORPORATE, name: 'Corporate', thumbnail: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=400', description: 'Professional blue business-style layout.' },
];
